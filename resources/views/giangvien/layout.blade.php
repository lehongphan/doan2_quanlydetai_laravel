...
<body>
  ...
  <div class="sh-sideleft-menu">
    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a href="{{ route('detai.index') }}"
          class="nav-link {{ 'giangvien/detai' ==request()->path() ? 'active' : ''}}">
      ...
      <li class="nav-item">
        <a href="{{ route('detaiddk.index') }}"
          class="nav-link {{ 'giangvien/detaiddk' ==request()->path() ? 'active' : ''}}">
          <i class="icon ion-ios-bookmarks-outline"></i>
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <ul class="dropdown-profile-nav">
            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                  ...
                  class="icon ion-power"></i> Đăng xuất</a></li>
          </ul>
