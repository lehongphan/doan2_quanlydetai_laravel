  ...
  <!--menu navi-->
      <div class="sh-sideleft-menu">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('detaisv.index') }}" class="nav-link {{ '/detaisv' ==request()->path() ? 'active' : ''}}">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <div class="media align-items-center">
                ...
                <div class="media-body">
                  <h6 class="tx-inverse tx-15 mg-b-5">{{Auth::guard()->user()->hoLot}}<a> <a>{{Auth::guard()->user()->ten}}</h6>
                  <p class="mg-b-0 tx-12">{{Auth::guard()->user()->email}}</p>
                </div><!-- media-body -->
              </div><!-- media -->
              <hr>
